...
Для оплаты доступно несколько систем: Яндекс.Деньги (в том числе: MasterCard, Maestro, Visa), WebMoney
(так же можно оплатить через банки, терминалы, киви) и PayPal (необходим аккаунт PayPal).
