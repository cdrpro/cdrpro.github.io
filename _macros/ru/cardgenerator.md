...
**ВАЖНО:** Текущий макрос больше не поддерживается, но вы всё равно можете его купить,
например, если вам нужна совместимость с версиями X3-X6. Однако лучше использовать
новый [CardGenerator Docker](/macros/cardgenerator/), разработанный для X7 и выше.
