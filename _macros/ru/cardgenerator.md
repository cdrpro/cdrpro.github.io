...
**ВАЖНО:** Текущий макрос больше не поддерживается и может неправильно работать на некоторых конфигурациях.
Лучше использовать новый [CardGenerator Docker](/macros/cardgenerator/), разрабатываемый для CorelDRAW X7 и новее.
...
и его никак не обойти. Также, макрос может не запоминать дополнительные настройки Мастера Штрих-кодов.

### Совместимость

**Важно!!!** Макрос может не работать в Windows 10. Для CorelDRAW X7 и выше,
лучше использовать новый [CardGenerator Docker](/macros/cardgenerator/).
